...
def create_gan(discriminator, generator, latent_dim):
    ...
    gan= tf.keras.Model(inputs=gan_input, outputs=gan_output, name="GAN")
...
def train(g_model, d_model, gan_model, dataset, latent_dim, n_epochs=201, n_batch=512):
...
# train model
# train(generator, discriminator, gan_model, X_train, latent_dim=NOISE_DIM)
